...
import demo.data.api.RxHttpService;
import demo.data.repository.HttpRepository;
import demo.data.response.BaseObserver;
import demo.data.response.HttpCallback;
import demo.databinding.ActivityHttpBinding;
